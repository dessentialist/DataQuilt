 ...
 *
 * Centralizes error classification for LLM provider errors (OpenAI, Gemini, Perplexity, DeepSeek).
 ...
 * @param provider - The LLM provider (openai, gemini, perplexity, deepseek)
...
export function categorizeLLMError(
  ...
  if (
    ...
    return {
      category: "AUTH_ERROR",
      retryable: false,
      userMessage: "Your organization must be verified to use this model. Please verify your organization through your account in the LLM provider (OpenAI, Gemini, Perplexity, DeepSeek).",
