...
import { computeOpenAIEffectiveParams, computePerplexityEffectiveParams, computeGeminiEffectiveParams } from "./llm.capabilities";
 ...
 * Provides unified interface across OpenAI, Gemini, and Perplexity models.
 */
export class LLMService {
  ...
  async processMessages(
    ...
    console.log(`[LLMService] message_meta`, { hasSystem: Boolean(messagesInput.systemText), systemLen, userLen });
    ...
    try {
      ...
      console.error(`[LLMService] processMessages error categorized`, {
        provider: model,
        category: categorized.category,
